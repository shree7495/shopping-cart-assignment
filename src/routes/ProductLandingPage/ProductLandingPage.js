...
// import productList from "../../server/products/index.get.json";
...
import babyShampoo from "../../images/products/baby/shampoo.jpg";
...
export default function ProductLandingPage() {
  ...
  useEffect(() => {
    ...
    if (id) {
      finalProductList = productList.filter((product) => {
